...
HD_PWD='D:/K14/code/convolution_image/convolution_image.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_convolution_image.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_convolution_image.tcl
